        ...
        <header class="w-full py-6 px-8 bg-white shadow-md fixed top-0 z-50 flex justify-between items-center">
            ...
            <nav>
                <ul class="flex space-x-9">
                    ...
                    <li><a href="{{ route('portfolio.index') }}" class="hover:text-green-600">Portfolio</a>
                    </li>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between mt-6 gap-10">
                ...
                <div class="w-full md:w-1/2 flex justify-start relative ">
                    <div class="relative">
                        ...
                        <div class="absolute left-0 top-16 w-60 h-60 border-4 border-black bg-transparent rounded-lg z-10">
                        </div>
                        <img src="/assets/images/poto.png" alt="Profile Picture"
                            class="absolute left-6 bottom-14 w-60 h-80 object-cover rounded-lg relative z-20">
                    </div>
                </div>
                ...
                <div class="w-full md:w-1/2">
                    <p class="text-lg text-gray-600 text-justify">
                        Hi, I'm <span class="text-green-600 font-semibold">Nabil Huda Rizalul Haq</span>, a passionate
                        Mobile Developer specializing in Flutter and Laravel.
                        I have a deep understanding of mobile and web development, focusing on delivering high-quality and
                        scalable applications.
                    </p>

                    <p class="text-lg text-gray-600 text-justify mt-4">
                        With years of experience in <strong>Flutter, Laravel, React.js, and PostgreSQL</strong>, I have
                        successfully built various applications for startups and enterprises.
                        My goal is to create seamless and efficient applications that enhance user experience.
                    </p>

                    <p class="text-lg text-gray-600 text-justify mt-4">
                        Apart from coding, I love contributing to the tech community, sharing knowledge through blogs, and
